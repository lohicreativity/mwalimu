...
Route::middleware(['auth:sanctum', 'verified'])->group(function(){
 ...
 //   Route::post('application-batch/store', [ApplicationBatchController::class,'store']);
    ...
    Route::get('reset-applicant-window',[ApplicationController::class,'resetIndividualApplicantWindowStatus']);
    Route::get('reset-applicant-confirmation',[ApplicationController::class,'resetConfirmationStatus']);
