...
Route::middleware(['auth:sanctum', 'verified'])->group(function(){
	...
	Route::get('staff-module-assignment/{id}/results/students-with-incomplete-results', [ModuleAssignmentController::class,'studentsWithIncompleteResults']);
	Route::get('staff-module-assignment/{id}/results/postponed-students', [ModuleAssignmentController::class,'postponedStudents']);
	...
	Route::get('results/process-supp-results',[ExaminationResultController::class,'processSuppResults']);
	Route::get('results/process-student-supp-results',[ExaminationResultController::class,'processStudentSuppResults']);
	...
	Route::get('results/submit-examination-results',[ExaminationResultController::class, 'submitResults']);
	...
	Route::get('download-submitted-enrolled-students',[GraduantController::class,'downloadSubmittedEnrolledStudents']);
