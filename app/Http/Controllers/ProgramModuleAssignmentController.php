...
class ProgramModuleAssignmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(ProgramModuleAssignment::where('module_id',$request->get('module_id'))->where('semester_id',$request->get('semester_id'))->where('year_of_study',$request->get('year_of_study'))->where('campus_program_id',$request->get('campus_program_id'))->count() != 0){
