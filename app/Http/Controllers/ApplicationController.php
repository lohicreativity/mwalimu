...
class ApplicationController extends Controller
{
    ...
    public function admittedApplicants(Request $request)
    {
         ...
         $applicants = Applicant::whereHas('selections',function($query) use($request){
            ...
            })->with(['intake','selections.campusProgram.program'])->where('application_window_id',$request->get('application_window_id'))->where('program_level_id',$request->get('program_level_id'))->where('status','ADMITTED')->get();
