...
class ApplicationController extends Controller
{
    ...
    public function showApplicantsList(Request $request)
    {
        ...
        if($request->get('status') == 'progress'){
           $applicants = Applicant::with(['selections.campusProgram.program', 'programLevel', 'payment'])->where('programs_complete_status',0)->where('submission_complete_status',0)->where('application_window_id',$request->get('application_window_id'))->where('campus_id',$application_window->campus_id)->paginate(20);
