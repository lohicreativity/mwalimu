         ...
         if ($request->get('program_level_id')) {
            ...
            $applicants = Applicant::doesntHave('student')->whereDoesntHave('student')->whereHas('selections',function($query) use($request){
                $query->where('status','SELECTED');
                  ...
                  })->where('status','ADMITTED')->orderBy('tuition_payment_check','DESC')->orderBy('other_payment_check','DESC')->orderBy('documents_complete_status','DESC')->orderBy('updated_at','DESC')->get();
