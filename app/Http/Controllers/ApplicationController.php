...
class ApplicationController extends Controller
{
	 ...
	 */
	 public function resetSelections(Request $request)
	 {
		 ...
		 Applicant::where('application_window_id',$request->get('application_window_id'))->where('campus_id',$staff->campus_id)->where('program_level_id',$request->get('program_level_id'))->where('applicant.status','!=','ADMITTED')->where('applicant.status','!=','SUBMITTED')->update(['status'=>null]);
