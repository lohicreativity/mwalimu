    ...
    public function sendAdmissionLetter(Request $request)
    {
        ...
        foreach($applicants as $applicant){
           // try{
               ...
               $pdf = PDF::loadView('dashboard.application.reports.admission-letter',$data)->storeAs(base_path('public/uploads'),'Admission-Letter-'.$applicant->first_name.'-'.$applicant->surname.'.pdf');
