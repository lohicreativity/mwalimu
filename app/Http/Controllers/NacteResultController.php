...
class NacteResultController extends Controller
{
    ...
    public function confirm(Request $request)
    {
        ...
        }elseif(str_contains($applicant->programLevel->name,'Diploma') || str_contains($applicant->programLevel->name,'Master') && $applicant->entry_mode == 'EQUIVALENT' && $o_level_result_count != 0){
            $applicant->results_complete_status = 1;
        }
        $applicant->save();
