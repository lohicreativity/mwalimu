...
/* 		foreach($internal_trasnfers as $transfers){
        ...
        $data = [
           'staff'=>$staff,
           'postponements_arc_count'=>Postponement::whereNull('postponed_by_user_id')->whereNull('recommended_by_user_id')->count(),
           'resumptions_arc_count'=>Postponement::whereNotNull('postponed_by_user_id')->whereNull('resumed_by_user_id')->count(),
           'special_exams_arc_count'=>SpecialExamRequest::whereNull('approved_by_user_id')->whereNull('recommended_by_user_id')->count(),
