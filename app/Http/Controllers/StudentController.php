...
class StudentController extends Controller
{
	...
	/* return Student::whereHas('TranscriptRequest', function($query) use($student)
		...
		$data = [
			...
			'transcript_request_status'=> TranscriptRequest::select('status','DATE_FORMAT(updated_at, "%d-%b-%Y") as issued_date')->where('student_id', $student->id)->where('status', 'ISSUED')->latest()->first()
		];
