...
/*             if(Util::stripSpacesUpper($semester->name) == Util::stripSpacesUpper('Semester 2')){
    ...
    public function getGlobalReport(Request $request)
    {
         ...
         foreach($departments as $department){
               ...
               foreach($department->programs as $program){
                  if($program->nta_level_id == $level->id){
                     ...
                     $report[$level->name][$department->name]['take_students'] = 0;
                     $report[$level->name][$department->name]['miss_take_students'] = 0;
                     $report[$level->name][$department->name]['post_students'] = 0;
                     $report[$level->name][$department->name]['inc_students'] = 0;
                     ...
                     $report[$level->name][$department->name]['take_students_rate'] = 0;
                     $report[$level->name][$department->name]['miss_take_students_rate'] = 0;
                     $report[$level->name][$department->name]['ML']['take_students'] = 0;
                     $report[$level->name][$department->name]['FL']['take_students'] = 0;
                     $report[$level->name][$department->name]['ML']['post_students'] = 0;
                     $report[$level->name][$department->name]['FL']['post_students'] = 0;
                     $report[$level->name][$department->name]['ML']['inc_students'] = 0;
                     $report[$level->name][$department->name]['FL']['inc_students'] = 0;
      ...
      $results = ExaminationResult::select('final_exam_remark','module_assignment_id','student_id')
                                  ...
                                  ->with(['moduleAssignment.programModuleAssignment.module.ntaLevel:id,name','student:id,gender'])->limit(100)->get();
               ...
               foreach($departments as $department){
                  ...
                  foreach($department->programs as $program){
                     if($program->nta_level_id == $result->moduleAssignment->programModuleAssignment->module->nta_level_id){
                        ...
                        $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['total_students'] += 1;
                       // if($result->final_exam_remark == 'PASS' || $result->final_exam_remark == 'FAIL' || $result->final_exam_remark == 'RETAKE' || $result->final_exam_remark == 'CARRY'){
                              //$report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['take_students'] += 1;

                              // $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['take_students_rate'] = $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['take_students']*100/$report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['total_students'];

                              // if($result->student->gender == 'M'){
                              //    $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['ML']['take_students'] += 1;
                              // }

                              // if($result->student->gender == 'F'){
                              //    $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['FL']['take_students'] += 1;
                              // }
                       // }

                        if($result->final_exam_remark == 'PASS'){
                              $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['pass_students'] += 1;

                             //$report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['pass_students_rate'] = $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['pass_students']*100/$report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['total_students'];

                              if($result->student->gender == 'M'){
                                 $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['ML']['pass_students'] += 1;
                              }

                              if($result->student->gender == 'F'){
                                 $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['FL']['pass_students'] += 1;
                              }
                        }

                        // if($result->final_exam_remark == 'FAIL' || $result->final_exam_remark == 'RETAKE' || $result->final_exam_remark == 'CARRY'){
                        //       $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['fail_students'] += 1;

                        //       $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['fail_students_rate'] = $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['fail_students']*100/$report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['total_students'];

                        //       if($result->student->gender == 'M'){
                        //          $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['ML']['fail_students'] += 1;
                        //       }

                        //       if($result->student->gender == 'F'){
                        //          $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['FL']['fail_students'] += 1;
                        //       }
                        // }

                        // if($result->final_exam_remark == 'POSTPONED'){
                        //       $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['post_students'] += 1;

                        //       $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['post_students_rate'] = $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['post_students']*100/$report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['total_students'];

                        //       if($result->student->gender == 'M'){
                        //          $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['ML']['post_students'] += 1;
                        //       }

                        //       if($result->student->gender == 'F'){
                        //          $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['FL']['post_students'] += 1;
                        //       }
                        // }

                        // if($result->final_exam_remark == 'INCOMPLETE'){
                        //       $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['inc_students'] += 1;

                        //       $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['inc_students_rate'] = $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['inc_students']*100/$report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['total_students'];

                        //       if($result->student->gender == 'M'){
                        //          $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['ML']['inc_students'] += 1;
                        //       }

                        //       if($result->student->gender == 'F'){
                        //          $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['FL']['inc_students'] += 1;
                        //       }
                        // }

                        // if($result->final_exam_remark == 'INCOMPLETE' || $result->final_exam_remark == 'POSTPONED'){
                        //       $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['miss_take_students'] += 1;

                        //       $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['miss_take_students_rate'] = $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['miss_take_students']*100/$report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]['total_students'];
                        // }
