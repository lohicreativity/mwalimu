      ...
      foreach($departments as $department){
         foreach($department->programs as $program){
            ...
            foreach($module_assignments as $assignment){
               ...
               foreach($results as $result){
                  return $report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name]; //.' - '.$report[$result->moduleAssignment->programModuleAssignment->module->ntaLevel->name][$department->name][$program->name];
