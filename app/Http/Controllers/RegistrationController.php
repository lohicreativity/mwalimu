	  ...
	  public function showActiveStudents(Request $request)
	  {
		   ...
		   if(Auth::user()->hasRole('hod')){
			  ...
			  ->with(['student:id,applicant_id,first_name,middle_name,surname,gender,campus_program_id,registration_number,studentship_status_id,phone,email',
                      ...
                      'student.applicant.nextOfKin:first_name,middle_name,surname,gender,phone,nationality,address,country_id,region_id,district_id,ward_id',
                      ...
                      'student.applicant.nacteResultDetails:id,verified,avn',
                      'student.applicant.nectaResultDetails:id,exam_id,verified,index_number',
