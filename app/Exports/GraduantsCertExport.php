...
class GraduantsCertExport implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        ...
        foreach ($programs as $key => $program) {
            ...
            $sheets[] = new GraduantsCertPerProgramSheet($program->program->id, $program->program->code, $program->program->name, $department->name, $program->campus->name,$this->study_academic_year_id);
        }
