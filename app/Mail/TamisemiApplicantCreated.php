...
class TamisemiApplicantCreated extends Mailable
{
    ...
    public function build()
    {
        return $this->view('emails.tamisemi-applicant')
                    ->subject('MNMA Selection')
                    ->with([
                        'heading'=>'MNMA Selection',
                        'name'=>$this->student->fullname,
                        'notification_message'=>'I am pleased to inform you that you have been selected for '.$this->program_name.' at The Mwalimu Nyerere Memorial Academy.'.' Please visit http://41.59.91.194/application/login to log in to your user account to provide more information. Your username and password are as follows;',
