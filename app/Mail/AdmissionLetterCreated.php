    ...
    public function build()
    {
        ...
        return $this->view('emails.admission-letter')
                    ...
                    ->with([
                       ...
                       'notification_message'=>'We apologise for our previous email regarding the Admission Letter. The letter had incorrect dates. Please find the attached Admission Letter, with the correct dates, and 
