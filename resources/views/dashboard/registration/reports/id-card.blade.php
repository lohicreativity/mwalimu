...
<body>
   ...
   <div id="ss-id-card" class="ss-id-card" style="width: 750px; height: 400px; background-image: url({{ asset('img/mnma-id-bg.png') }});">
    ...
    <div class="row" style="background-color:#1b2066; width:100%; margin-top: -20px; position:absolute;">
        <div class="col-md-6" style=" margin-top: -20px;"> @if($semester->name == 'Semester 1')
            <h5 style="text-align:left; color: white; font-weight: bold; padding-left: 5px;">Semester One</h5>
            @else
                <h5 style="text-align:left; color: white; font-weight: bold; padding-left: 5px;">Semester Two</h5>
            @endif
        </div>
        <div class="col-md-6" style="text-align: right;">
            <h5 style="float: right;  -webkit-text-stroke: 1px white; font-weight: bold; color: red; padding-right:5px;">{{ $student->campusProgram->campus->name }}</h5>
        </div>
    </div>  
   <!-- </div>
