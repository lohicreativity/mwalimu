...
<body>
   @if ($student->applicant->campus_id == 1)
        @if ($tuition_payment_check)
            <div id="ss-id-card" class="ss-id-card" style="background-image: url({{ asset('img/mnma-id-bg-semi 1&2 Kivukoni.jpg') }});  background-size:  71rem 47rem; background-repeat: no-repeat; width: 750px; height: 352px; ">
        @else
            <div id="ss-id-card" class="ss-id-card" style="background-image: url({{ asset('img/mnma-id-bg-semi 1-Kivukoni.jpg') }});  background-size:  71rem 12.78rem; background-repeat: no-repeat; width: 750px; height: 204.48px;">
        @endif
   @elseif($student->applicant->campus_id == 2)
        @if ($tuition_payment_check)
         <div id="ss-id-card" class="ss-id-card" style="background-image: url({{ asset('img/mnma-id-bg-semi 1&2 Karume.jpg') }});  background-size:  71rem 47rem; background-repeat: no-repeat; width: 750px; height: 352px; ">
        @else
         <div id="ss-id-card" class="ss-id-card" style="background-image: url({{ asset('img/WhatsApp Image 2023-10-16 at 14.42.44_9a95e42e.jpg') }});  background-size:  71rem 47rem; background-repeat: no-repeat; width: 750px; height: 352px; ">
        @endif
   @endif
