...
<div>
    ...
    <div style="position:absolute;top:0.75in;left:1.07in;width:1.94in;line-height:0.18in;">
        <span style="font-style:normal;font-weight:bold;font-size:7pt;color:#162F7F">NAME: </span><span style="font-style:normal;font-weight:bold;font-size:7pt">{{ $student->surname}}, {{$student->first_name}} {{ substr($student->middle_name,0,1) }}.  </span><br/>
