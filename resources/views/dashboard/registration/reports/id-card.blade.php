...
<body>
   ...
   <div id="ss-id-card" class="ss-id-card" style="width: 750px; height: 400px; background-image: url({{ asset('img/mnma-id-bg.png') }});">
    ...
    <div class="row" style="background-color:#1b2066; width:100%; height: 5%; margin-top: -15px; position:absolute;padding: 5px;">
        ...
        <div class="col-md-6" style="text-align: right;">
            <h2 style="float: right;  -webkit-text-stroke: 1px white; font-weight: bold; color: red; padding-right:5px; font-size: 30px;">{{ $student->campusProgram->campus->name }}</h2>
        </div>
    </div>  
   <!-- </div>
