...
<body>
   @if ($student->applicant->campus_id == 1)
        ...
        @else
            <div id="ss-id-card" class="ss-id-card" style="background-image: url({{ asset('img/IMG-20231029-WA0018.jpg') }});  background-size: 100% auto; background-repeat: no-repeat; width: 100%;height: 100%; margin-bottom: 25px; background-color: #000;">
        @endif
