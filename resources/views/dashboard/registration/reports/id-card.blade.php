...
<div>
    ...
    <div style="position:absolute;top:0.75in;left:1.07in;width:1.94in;line-height:0.18in;">
        <span style="font-style:italic;font-weight:bold;font-size:7pt;color:#162F7F">NAME: </span><span style="font-style:italic;font-weight:bold;font-size:7pt">{{ $student->first_name }} {{ $student->middle_name }} {{ $student->surname }} </span><br/>
        <span style="font-style:italic;font-weight:bold;font-size:7pt;color:#162F7F">PROGRAMME: </span><span style="font-style:italic;font-weight:bold;font-size:7pt;"> {{ str_replace('.','-',$student->campusProgram->program->code) }}</span><br/>
        <span style="font-style:italic;font-weight:bold;font-size:7pt;color:#162F7F">REG No: </span><span style="font-style:italic;font-weight:bold;font-size:7pt;">{{ $student->registration_number }}</span><br/>
        <span style="font-style:italic;font-weight:bold;font-size:7pt;color:#162F7F">VALID TO: </span><span style="font-style:italic;font-weight:bold;font-size:7pt;"> {{ str_replace('-', '/', App\Utils\DateMaker::toStandardDate($study_academic_year->end_date)) }}</span><br/>
    </div>
