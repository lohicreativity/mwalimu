...
<body>
   @if ($student->applicant->campus_id == 1)
        ...
        @else
            <div id="ss-id-card" class="ss-id-card" style="background-image: url({{ asset('img/IMG-20231029-WA0018.jpg') }});  background-size: cover; background-repeat: no-repeat; width: 305.28px; height: 204.48px;">
        @endif
