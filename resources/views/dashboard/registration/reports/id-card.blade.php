...
<body>
   @if ($student->applicant->campus_id == 1)
        ...
        @else
            <div id="ss-id-card" class="ss-id-card" style="background-image: url({{ asset('img/IMG-20231029-WA0018.jpg') }});  background-size:  75rem 47rem; background-repeat: no-repeat; width: 1200px; height: 400px;">
        @endif
