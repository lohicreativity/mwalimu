...
<body>
   @if ($student->applicant->campus_id == 1)
        ...
        @else
            <div id="ss-id-card" class="ss-id-card" style="background-image: url({{ asset('img/IMG-20231029-WA0018.jpg') }});  background-size: cover; background-repeat: no-repeat; width: 85rem; height: 47rem;">
        @endif
