   ...
   <div id="ss-id-card" class="ss-id-card" style="width: 750px; height: 400px; background-image: url({{ asset('img/mnma-id-bg.png') }});">
     ...
     <div class="row" style="background-color:#1b2066; margin-top: -1px; position:absolute; margin-right: -80px;">
        ...
        <div class="col-md-6" style="float: right;">
            <p style="-webkit-text-stroke: 1px white; font-weight: bold; color: red; text-align: right; padding-right: 30px;font-size: 16px;">{{ $student->campusProgram->campus->name }}</p>
        </div>
    </div> 
   </div>
    </div>
