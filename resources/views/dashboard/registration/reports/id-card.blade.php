...
<body>
   @if ($student->applicant->campus_id == 1)
        ...
        @else
            <div id="ss-id-card" class="ss-id-card" style="background-image: url({{ asset('img/mnma-id-bg-semi 1&2 Karume.png') }});  background-size:  71rem 50rem; background-position: center; background-repeat: no-repeat; width: 100%;height: 100%;">
        @endif
