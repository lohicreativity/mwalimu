     ...
     <div id="ss-id-card-back" class="ss-id-card" style="width: 750px; height: 400px; background-color: #FFF; ">
       ...
       <div class="row">
          <div class="col-md-7">
            ...
            <p style="margin: 0px 0px 5px 10px; font-size: 11px; padding-left: 15px; font-weight: bold; font-size: 12px; word-spacing: -2px;">THE MWALIMU NYERERE MEMORIAL ACADEMY</p>
