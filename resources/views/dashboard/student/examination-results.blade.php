            ...
            <div class="card">
              ...
              <div class="card-body">
                 ...
                 <table class="table table-bordered">
                   ...
                   <tr>
                      @if(count($years) > 1)
                      <td><a href="{{ url('student/results/'.0.'/'.$years[0]->id.'/'.$key.'/show-student-overall-results?next_ac_yr_id='.$years[1]->id) }}">Overall Results for Year {{ $key }}</a></td>
                      @else
                      <td><a href="{{ url('student/results/'.0.'/'.$years[0]->id.'/'.$key.'/show-student-overall-results?next_ac_yr_id=') }}">Overall Results for Year {{ $key }}</a></td>
                      @endif
                      <td>
                        @foreach($years as $yr)
