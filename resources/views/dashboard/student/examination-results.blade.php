              ...
              <div class="card-body">
                 ...
                 <table class="table table-bordered">
                   ...
                   <tr>
                      ...
                      <td><a class="btn btn-primary" href="{{ url('student/request-performance-report?year_of_study='.$key.'&study_academic_year_id='.$years[0]->id) }}">Request Statement of Results</a></td>
                   </tr>
                   @endforeach
                 </table>
