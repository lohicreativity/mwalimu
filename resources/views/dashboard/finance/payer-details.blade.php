									    ...
									    <table class="table table-bordered ss-paginated-table" style="font-size:10pt">
										  ...
										  <tbody>
											...
											<tr>
											   ...
											   <td title="@foreach($paid_receipts as $receipt) @if($receipt->bill_id == $payments->reference_no)  TZS {{ number_format($receipt->paid_amount,2) }} paid on {{ date('Y-m-d',strtotime($receipt->created_at)) }} '<br>' @endif @endforeach"> 
