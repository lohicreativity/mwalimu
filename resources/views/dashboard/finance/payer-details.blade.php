										  ...
										  <tbody>
											...
											<tr>
											   ...
											   <td>
												...
												@endif
											   <td title=@foreach($paid_receipts as $receipt) @if($receipt->bill_id == $payments->reference_no) "TZS: {{ $receipt->paid_amount }}, paid on {{ $receipt->created_at }}" @endif @endforeach>
