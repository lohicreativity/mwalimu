        ...
        <div class="card-header">
         ...
         <div class="card card-default">
              <div class="card-header">
                ...
                <a href="{{ url('finance/download-receipts?study_academic_year_id='.$request->get('study_academic_year_id').'&campus_id='.$request->get('campus_id')) }}" class="btn btn-primary">Download</a>
              </div>
              <div class="card-body">
                {{--
