        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
             <a href="{{ url('finance/down-loan-beneficiaries?study_academic_year_id='.$request->get('study_academic_year_id').'&year_of_study='.$request->get('year_of_study')) }}" class="btn btn-primary">Download Loan Beneficiaries</a>
