          ...
          <div class="col-12">
           ...
           <div class="card-header">
                <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item"><a class="nav-link active" href="{{ url('academic/module-assignment-requests?study_academic_year_id='.session('active_academic_year_id')) }}">{{ __('Modules Assignment Requests') }}</a></li>
                  @endcan
