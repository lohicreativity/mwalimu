                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      {!! Form::label('','Type') !!}
                      <select name="unit_category_id" class="form-control" id="unit-categories" data-target="#parents" data-token="{{ session()->token() }}" data-source-url="{{ url('api/v1/get-faculty-parents') }}" required>
                        <option value="">Select Type</option>
                        @foreach($unit_categories as $category)
                        <option value="{{ $category->id }}">{{ $category->name }}</option>
                        @endforeach
