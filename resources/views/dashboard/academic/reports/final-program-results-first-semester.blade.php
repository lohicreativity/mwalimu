     ...
     .ss-color-danger{
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
              <div class="ss-letter-head  ss-center">
               ...
               <span class="ss-bold" style="font-size:12pt">{{ $department->name }}</span> <br>
               <span class="ss-bold" style="font-size:12pt">{{ $program->name }} (YEAR {{ $year_of_study }} - {{ strtoupper(substr($intake->name,0,3)) }}) - {{ $study_academic_year->academicYear->year }}</span>
        ...
        <div class="row">
          <div class="col-md-8">
              <div class="ss-left">
                  <p class="ss-bold">Name of Head of Department: {{ strtoupper($staff->surname) e}}, {{ ucwords(strtolower($staff->first_name))}} {{ substr($staff->middle_name,0,1)}}</p>
