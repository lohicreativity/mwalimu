     ...
     .ss-color-danger{
      ...
      <div class="container">
                  ...
                  @foreach($classifications as $class)
                    <tr>
                      @if(str_contains(strtolower($class), 'first'))
                        ...
                        <td class="ss-font-sm">{{ round((($male_first_class_cases + $female_first_class_cases)/count($students))*100,1) }}</td>
                      @elseif(str_contains(strtolower($class), 'upper second'))
                        ...
                        <td class="ss-font-sm">{{ round((($male_upsecond_class_cases + $female_upsecond_class_cases)/count($students))*100,1) }}</td>
                      @elseif(strtolower($class) == 'second class'))
                        ...
                        <td class="ss-font-sm">{{ round((($male_second_class_cases + $female_second_class_cases)/count($students))*100,1) }}</td>
                      @elseif(str_contains(strtolower($class), 'lower'))
                        ...
                        <td class="ss-font-sm">{{ round((($male_lwsecond_class_cases + $female_lwsecond_class_cases)/count($students))*100,1) }}</td>
                      @elseif(str_contains(strtolower($class), 'pass'))
                        ...
                        <td class="ss-font-sm">{{ round((($male_pass_cases + $female_pass_cases)/count($students))*100,1) }}</td>
                      @endif
                    </tr>
                  @endforeach
                    <tr>
                      ...
                      <td class="ss-font-sm">{{ round((($male_failed_cases + $female_failed_cases)/count($students))*100,1) }}</td>
                    </tr>
                    <tr>
                      ...
                      <td class="ss-font-sm">{{ round((($male_retake_cases + $female_retake_cases)/count($students))*100,1) }}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="ss-font-sm">{{ round((($male_carry_cases + $female_carry_cases)/count($students))*100,1) }}</td>
                    </tr>
                    @endif
                    <tr>
                      ...
                      <td class="ss-font-sm">{{ round((($male_incomplete_cases + $female_incomplete_cases)/count($students))*100,1) }}</td>
                    </tr>
                    <tr>
                      ...
                      <td class="ss-font-sm">{{ round((($male_postponement_cases + $female_postponement_cases)/count($students))*100,1) }}</td>
                    </tr>
                    <tr>
                      ...
                      <td class="ss-font-sm">{{ round((($male_disco_cases + $female_disco_cases)/count($students))*100,1) }}</td>
                    </tr>
                    <tr>
        ...
        <div class="row">
          <div class="col-md-8">
              <div class="ss-left">
                  <p class="ss-bold">Head of Department: <span class="font-weight-normal"> {{ strtoupper($staff->surname) }}, {{ ucwords(strtolower($staff->first_name))}} {{ substr($staff->middle_name,0,1)}} </span></p>
