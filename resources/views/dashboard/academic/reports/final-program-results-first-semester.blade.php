     ...
     .ss-color-danger{
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-8">
              <div class="ss-left">
                  <p class="ss-bold">Head of Department: <span class="ss-normal"> {{ strtoupper($staff->surname) }}, {{ ucwords(strtolower($staff->first_name))}} {{ substr($staff->middle_name,0,1)}} </span></p>
