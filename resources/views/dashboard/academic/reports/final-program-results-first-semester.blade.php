              ...
              <div class="ss-letter-head  ss-center">
               ...
               <div class="table-responsive ss-margin-bottom">
                  <table class="table table-condensed table-bordered">
                    <thead>
                      <tr>
                        <th class="ss-bold" rowspan="2">SN</th>
                        @if($request->get('reg_display_type') == 'SHOW')<th class="ss-bold" rowspan="2">Reg. No.</th>@endif
                        @if($request->get('name_display_type') == 'SHOW')<th class="ss-bold" rowspan="2">Name</th>@endif
                        @if($request->get('gender_display_type') == 'SHOW')<th class="ss-bold" rowspan="2">Sex</th>@endif
                        @foreach($module_assignments as $assignment)
                        <th class="ss-bold" colspan="4">{{ $assignment->module->code }} ({{ $assignment->module->credit }})</th>
                        @endforeach
                        <th colspan="5"></th>
                      <tr>
                      <tr>
