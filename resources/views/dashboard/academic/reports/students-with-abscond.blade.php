               ...
               <div class="table-responsive ss-margin-bottom">
                  <table class="table table-condensed table-bordered">
                    ...
                    <tr>
                      ...
                      <td>@if(is_null($result->course_work_score)) -- @else {{ $result->course_work_score }} @endif</td>
                      <td>@if(is_null($result->final_score)) -- @else {{ $result->final_score }} @endif</td>
                      <td>@if(is_null($result->course_work_score) || is_null($result->final_score)) ABSCOND @endif</td>
                    </tr>
                    @endforeach
                  </table>
