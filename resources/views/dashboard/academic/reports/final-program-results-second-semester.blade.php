        ...
        <div class="row">
          <div class="col-md-12">
              <div class="ss-letter-head  ss-center">
               ...
               <p class="ss-bold font-size:14pt">@if($semester) {{ strtoupper($semester->name) }} @endif EXAMINATION RESULTS <span class="font-weight:normal">(CA Weight {{ (round($module_assignments[0]->programModuleAssignment->course_work_min_mark,0)) }}%, FE Weight {{(round($module_assignments[0]->programModuleAssignment->final_min_mark,0))}}%)</span> </p> 
              </div>
