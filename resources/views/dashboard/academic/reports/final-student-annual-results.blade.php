                 ...
                 <table class="table table-bordered">
                    ...
                    @foreach($core_programs as $program)
                      ...
                      @foreach($results as $result)
                         ...
                         <tr>
                          <td>{{ $count }}</td>
                          <td>@if($result->final_exam_remark != 'POSTPONED')<a href="{{ url('academic/results/'.$student->id.'/'.$study_academic_year->id.'/'.$result->moduleAssignment->programModuleAssignment->id.'/edit-student-results') }}">{{ $result->moduleAssignment->module->code }}</a> {{ $result->moduleAssignment->module->code }} @else @endif</td>
