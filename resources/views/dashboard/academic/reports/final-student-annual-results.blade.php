                ...
                <div class="col-12">
                          ...
                          @foreach($results as $result)
                            @if($result->moduleAssignment->programModuleAssignment->semester_id == $semester->id && $result->moduleAssignment->programModuleAssignment->id == $program->id)
                              ...
                              @endphp
                                <tr>
                                  <td>{{ $count }}</td>
                                  <td>@if($result->final_exam_remark != 'POSTPONED' && ($result->course_work_score != null || $result->final_score != null || $result->supp_score != null))
                 ...
                 <table class="table table-bordered">
                   ...
                   <tbody>
                      ...
                      <tr>
                        <td>@if($remark->remark == 'SUPP') <strong>{{ $remark->supp_remark }} </strong> @else <strong>{{ $remark->remark }}</strong> @endif
                          @if($remark->remark != 'REPEAT' && $remark->remark != 'FAIL&DISCO' && $remark->remark != 'DECEASED' && !str_contains($remark->remark, 'POSTPONE E'))
