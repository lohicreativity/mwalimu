  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Exam Postponement Recommendation</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Exam Postponement Recommendation</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                 ...
                 <div class="card-body">
                   ...
                   <div class="row">
                    <div class="form-group col-12">
                      ...
                      {!! Form::input('hidden','special_exam_request_id',$postponement->id) !!}
                    </div>
                 </div>
                 </div>
