                ...
                <table id="example2" class="table table-bordered table-hover ss-margin-top">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          @if($appeal->is_downloaded == 1 && $appeal->is_attended == 0) 
                          <span class="badge badge-warning">On Progress</span> 
                          @elseif($appeal->is_downloaded == 0 && $appeal->is_attended == 0) 
                          <span class="badge badge-warning">Pending</span> 
                          @elseif($appeal->is_attended == 1) 
                          <span class="badge badge-success">Completed</span> 
                          @else <span class="badge badge-success">Completed</span> @endif
                      </td>
