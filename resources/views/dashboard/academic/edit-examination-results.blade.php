                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-4">
                      ...
                      <a href="{{ url('academic/results/'.$student->id.'/'.$result->moduleAssignment->id.'/'.$result->id.'/edit-course-work-results?hod_request=1') }}" class="ss-margin-top">Edit Coursework</a>
                    </div>
                    <div class="form-group col-4">
