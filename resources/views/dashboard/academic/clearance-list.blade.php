                   ...
                   <tbody>
                    @foreach($clearances as $clearance)
                     <tr>
                       ...
                       @if(Auth::user()->hasRole('finance-officer'))
                       <td>@if($clearance->finance_status === 0) <i class="fa fa-close"></i> @endif<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#ss-stage-finance-{{ $clearance->id }}">Clear</a>
                      ...
                      <!-- /.modal -->
                       ...
                       @endif
                       @if(Auth::user()->hasRole('librarian'))
                       <td>@if($clearance->library_status === 0) <i class="fa fa-close"></i> @endif
                      ...
                      <!-- /.modal -->
                       ...
                       @if(Auth::user()->hasRole('dean-of-students'))
                       <td>
                         @if($clearance->hostel_status === 0) <i class="fa fa-close"></i> @endif
                      ...
                      @if(Auth::user()->hasRole('hod'))
                       <td>
                           @if($clearance->hod_status === 0) <i class="fa fa-close"></i> @endif
