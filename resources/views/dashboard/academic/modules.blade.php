                                ...
                                {!! Form::open(['url'=>'academic/module/update','class'=>'ss-form-processing','files'=>true]) !!}
                                  <div class="row">
                                   ...
                                   <div class="row">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                          <input class="custom-control-input" type="radio" id="customRadio3" name="course_work_based" value="1" @if($module->course_work_based == 1) checked="checked" @endif required>
                                          <label for="customRadio3" class="custom-control-label">Coursework Based</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                          <input class="custom-control-input" type="radio" id="customRadio4" name="course_work_based" value="0" @if($module->course_work_based == 0) checked="checked" @endif required>
                                          <label for="customRadio4" class="custom-control-label">Non-Coursework Based</label>
                                        </div>
                                    </div>
                                     </div>
