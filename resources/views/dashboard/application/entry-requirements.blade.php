                                                   ...
                                                   @if(filled($selectedEntryRequirement))
                                                      ...
                                                      <div class="card-body">
                                                         ...
                                                         <div class="form-group col-4">
                                                            ...
                                                            <select name="exclude_subjects[]" class="form-control ss-select-tags" multiple="multiple">
                                                               @foreach($subjects as $sub)
                                                               <option value="{{ $sub->subject_name }}" @if(unserialize($selectedEntryRequirement->exclude_subjects) != '') 
                                                                                                            @if(in_array($sub->subject_name,unserialize($selectedEntryRequirement->exclude_subjects))) selected="selected" @endif 
                                                                                                      @endif>
                                                                     {{ $sub->subject_name }}
                                                               </option>
                                                               @endforeach
