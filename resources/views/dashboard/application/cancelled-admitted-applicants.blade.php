  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Cancelled Applicants</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"><a href="#">Cancelled Applicants</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                    ...
                    @foreach($applicants as $applicant)
                      ...
                      @foreach($applicant->selections as $selection)
                          <tr>
                              ...
                              <td>
                                @if($applicant->status == 'ADMITTED' && $applicant->confirmation_status == 'CANCELLED')
                                <span class="badge badge-success"> ADMITTED </span> <br>   
                                <span class="text-sm" style="font-style: italic; font-color:red">Cancelled Admission</span> 
                                @endif
                              </td>
