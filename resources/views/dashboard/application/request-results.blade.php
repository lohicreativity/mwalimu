          ...
          <div class="col-12">
            ...
            <div class="card card-default">
              ...
              <div class="card-body">
                  ...
                  <label class="radio-inline">
                    <input type="radio" name="veta_certificate_status" id="inlineRadio3" value="1"> I have Veta Certificate
                  </label>
                  <label class="radio-inline">
                    <input type="radio" name="veta_certificate_status" id="inlineRadio4" value="0"> I do not have Veta Certificate
                  </label>
              </div>
              <div class="card-footer">
