                     ...
                     <tbody>
                       ...
                       <tr>
                         ...
                         <td>@if(count($applicant->insurances) != 0) 
								@if($applicant->insurances[0]->verification_status == 'VERIFIED') <span style="font-size: 11pt" class="badge badge-success"> Valid </span> 
								@elseif($applicant->insurances[0]->verification_status == 'UNVERIFIED') <span style="font-size: 11pt" class="badge badge-danger"> Invalid </span>
								@else <span style="font-size: 11pt" class="badge badge-warning"> Pending </span>	
								@endif	
							 @endif
						 </td>		
                         <td>
