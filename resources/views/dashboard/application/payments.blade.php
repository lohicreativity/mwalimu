                ...
                @if($fee_amount)
                 <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td>{{ $invoice->control_no }} @if($invoice->control_no == null) <a href="#" onclick="window.location.reload();">Refresh</a>@else <a href="#" id="ss-reset-control-number" data-token="{{ session()->token() }}" data-applicant-id="{{ $applicant->id }}" data-invoice-id="{{ $invoice->id }}"><i class="fa fa-refresh" ></i> Reset</a> @endif</td>
                    </tr>
                    @endif
                    @if(!$invoice)
                    <tr>
