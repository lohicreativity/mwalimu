...
<li>  Kindly note that candidates who will fail to register within the period of two weeks lasting from {{ Carbon\Carbon::parse($commencement_date)->format('jS F, Y') }} to {{ Carbon\Carbon::parse($commencement_date)->addDays(14)->format('jS F, Y') }} will be required to pay late registration fee of {{ $currency }} {{ number_format($late_registration_fee) }} per day for a maximum of 7 days. Failure to register within this period will lead to <strong>automatic cancellation</strong> of your admission; hence you will therefore be required to re-apply.</li>

<li>The Academy is a state owned higher learning institution and therefore all payments shall be paid using control numbers. Control numbers for all the payments can be requested and obtained from your system account six weeks before commencement of the academic year i.e. {{ Carbon\Carbon::parse($commencement_date)->format('jS F, Y') }} date. </li>
