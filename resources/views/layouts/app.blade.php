        ...
        campus_id: $('#campus_id').val()
          ...
          if (status == "success") {
            ...
            if ('campus' in data) {
              ...
              $("#parents").remove();
              $("#parent_input").html('<input type="text" class="form-control" readonly value="'+data.campus.name+'"></input>')
              $("#parent_input").html('<input type="hidden" name="parent_id" value="'+data.campus.id+'"></input>')
