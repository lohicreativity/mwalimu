          ...
          @if(Auth::user()->hasRole('applicant'))
           @if(isset($applicant))
            @if($applicant->status == null)
              ...
              <li class="nav-item">
                <a @if($applicant->is_tcu_verified != 1 && str_contains($applicant->programLevel->name,'Degree')) disabled="disabled" @elseif($applicant->is_tcu_verified == 1 && str_contains($applicant->programLevel->name,'Degree') && $applicant->is_transfered == 1) disabled="disabled" @else href="{{ url('application/next-of-kin') }}" @endif class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a @if(($applicant->is_tcu_verified != 1 && str_contains($applicant->programLevel->name,'Degree')) || $applicant->basic_info_complete_status != 1) disabled="disabled" @else href="{{ url('application/payments') }}" @endif class="nav-link">
			     ...
			     @endif
              <li class="nav-item">
                <a @if($applicant->is_tcu_verified != 1 && str_contains($applicant->programLevel->name,'Degree')) disabled="disabled" @elseif($applicant->is_tcu_verified == 1 && str_contains($applicant->programLevel->name,'Degree') && $applicant->is_transfered == 1) disabled="disabled" @else href="{{ url('application/results') }}" @endif class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
			   ...
			   @if($applicant->is_transfered != 1)
              <li class="nav-item">
                <a @if($applicant->is_tcu_verified != 1 && str_contains($applicant->programLevel->name,'Degree')) disabled="disabled" @elseif($applicant->is_tcu_verified == 1 && str_contains($applicant->programLevel->name,'Degree') && $applicant->is_transfered == 1) disabled="disabled" @else href="{{ url('application/select-programs') }}" @endif class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="{{ url('application/upload-avn-documents') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Upload Documents @if($applicant->avn_no_results === 1 || $applicant->teacher_certificate_status === 1) <i class="fa fa-check"></i> @endif</p>
                </a>
              </li>
              @endif
              @endif
              @if($applicant->is_tamisemi != 1)
              <li class="nav-item">
                <a @if($applicant->is_tcu_verified != 1 && str_contains($applicant->programLevel->name,'Degree')) disabled="disabled" @elseif($applicant->is_tcu_verified == 1 && str_contains($applicant->programLevel->name,'Degree') && $applicant->is_transfered == 1) disabled="disabled" @else href="{{ url('application/submission') }}" @endif class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
